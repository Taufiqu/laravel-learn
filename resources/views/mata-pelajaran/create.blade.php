                    ...
                    <form method="POST" action="{{ route('mata-pelajaran.store') }}">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="jenis" 
                                        ...
                                        <option value="lokal" {{ old('jenis') == 'lokal' ? 'selected' : '' }}>Lokal</option>
                                    </select>
                                    @error('jenis')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="deskripsi" 
                                      ...
                                      class="w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
